  ...
  tabPanel("HiPerMAb",
           tabsetPanel(
             ...
             tabPanel("HiPerMAb power",
                      ...
                      splitLayout("confidence level (1-alpha)",
                      ...
                      tabPanel("show plot",
                               ...
                               actionButton( "Dplot", "show 3D plot"),
                               plotOutput("D.plot")
                      )
...
server <- function(input, output) {
  ...
  Dplot<- eventReactive(input$Dplot, {
    ...
    plot.no.required.true.biomarkers(seq(from=input$bc.no1,to=input$bc.no2,by=50),
                                     seq(from=input$pv.no1,to=input$pv.no2,by=0.002),theta=input$theta,phi=input$phi,grid.plot=input$grid.plot)
  })
